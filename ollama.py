    ...
    def _convert_messages_to_ollama_messages(
        ...
        for message in messages:
            ...
            if isinstance(message, HumanMessage):
                ...
                message = HumanMessage("The result from that tool call is " + message.content +
                                       " . Please continue to give the next tool call if the process needs continue. "
                                       + "Please give the next tool call, in JSON format, and only the next tool call please.")
                role = "user"
            else:
